...
int main(void)
{
  ...
  std::cout << "sqrt1:" << std::endl;
  for (int i = 0; i < 4; i++)
  {
    std::cout << values[i] << " " << sqrt1<2>(values + i) << std::endl;
  } */
  ...
  for (int i = 0; i < 4; i++)
  {
    std::cout << values[i] << " " << root[i] << std::endl;
  }
  
  std::cout << "sqrt3:" << std::endl;
  sqrt3<2>(values, root2);
  for (int i = 0; i < 4; i++)
  {
    std::cout << values[i] << " " << root2[i] << std::endl;
  } */
